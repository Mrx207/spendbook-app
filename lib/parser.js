...
export function categorise(txn, rules, categories) {
  ...
  for (const r of rules) {
    try { if (new RegExp(r.pattern,"i").test(hay) && categories.some(c=>c.id===r.categoryId)) return r.categoryId; } catch {}
  }
...
export const DEFAULT_RULES = [
  ...
  ["credit card (bill|payment)|card ?payment|cred |autopay.*card|billdesk.*card|own account|self transfer|to your own","transfer"],
  ...
  ["salary|sal cr|reimbursement|refund|cashback|interest credit","income"],
];

export const DEFAULT_CATEGORIES = [
  { id:"food",name:"Food & Dining",icon:"🍜",color:"#EF6F63",budget:0 },
  { id:"groceries",name:"Groceries",icon:"🧺",color:"#7FA05A",budget:0 },
  { id:"transport",name:"Transport",icon:"🛺",color:"#5B9BD5",budget:0 },
  { id:"fuel",name:"Fuel",icon:"⛽",color:"#8C6239",budget:0 },
  { id:"shopping",name:"Shopping",icon:"🛍️",color:"#D9569E",budget:0 },
  { id:"bills",name:"Bills & Recharge",icon:"💡",color:"#F2C14E",budget:0 },
  { id:"subs",name:"Subscriptions",icon:"🔁",color:"#63B7DE",budget:0 },
  { id:"rent",name:"Rent",icon:"🏠",color:"#A0A6B0",budget:0 },
  { id:"emi",name:"EMI & Loans",icon:"🏦",color:"#B05C8E",budget:0 },
  { id:"health",name:"Health",icon:"💊",color:"#4BB6A8",budget:0 },
  { id:"fun",name:"Entertainment",icon:"🎬",color:"#9B7FD4",budget:0 },
  { id:"invest",name:"Investments",icon:"📈",color:"#B8C34A",budget:0 },
  { id:"travel",name:"Travel",icon:"✈️",color:"#63B7DE",budget:0 },
  { id:"family",name:"Family & Gifts",icon:"🎁",color:"#D9569E",budget:0 },
  { id:"cashwd",name:"Cash & ATM",icon:"🏧",color:"#A0A6B0",budget:0 },
  { id:"other",name:"Uncategorised",icon:"❔",color:"#6B7A93",budget:0 },
  { id:"transfer",name:"Transfer / Card bill",icon:"↔️",color:"#5A6B85",budget:0,excluded:true },
  { id:"income",name:"Income",icon:"💰",color:"#4BB6A8",budget:0 },
];
